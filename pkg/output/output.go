...
const (
	indexFile          = "index.txt"
	DefaultResponseDir = "urlreeper_response"
)
...
// Writer is an interface which writes output to somewhere for urlreeper events.
...
func New(options Options) (Writer, error) {
	...
	err = loadCustomFields(options.FieldConfig)
	if err != nil {
		return nil, err
	}
...
// Reference: https://github.com/youwannahackme/urlreeper/pull/537
